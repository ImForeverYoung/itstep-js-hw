...
const createUi = () => {
  ...
  cardSelector.addEventListener("click", () => {
    ...
    const game = createGame(gameContainer, gameTimer, (time) => {
      ...
      document.getElementsByClassName("results-block").classList.remove("results-block_hidden");
    ...
    const togglePause = () => {
      ...
      console.log(isRunning==false? "paused":"unpaused");
  ...
  buttonStart.addEventListener("click", () => {
    ...
    document.getElementsByClassName("results-block").classList.add("results-block_hidden");
